...
def main():
    ...
    results_basepath = 'weights/trpo/2d-navigation'
    results.append(policy_testing(f"{results_basepath}/10/policy.th", env, task))
    results.append(policy_testing(f"{results_basepath}/200/policy.th", env, task))
    results.append(policy_testing(f"{results_basepath}/500/policy.th", env, task))
